...
import { BrainCircuit, Menu, X, LayoutDashboard, LogOut, User as UserIcon } from "lucide-react";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="hidden sm:inline max-w-[140px] truncate text-xs font-semibold text-slate-700">
